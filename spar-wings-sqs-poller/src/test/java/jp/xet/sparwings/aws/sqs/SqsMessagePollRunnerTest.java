...
public class SqsMessagePollRunnerTest {
	
	private static Logger logger = LoggerFactory.getLogger(SqsMessagePollRunnerTest.class);
	...
	SqsMessagePollRunner sut;
	
	
	@Before
	public void setUp() throws Exception {
		sut = new SqsMessagePollRunner(sqs, retry, Q_URL, messageHandler, "testHandler");
