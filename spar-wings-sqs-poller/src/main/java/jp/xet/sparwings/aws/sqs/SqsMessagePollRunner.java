 ...
 */
@Slf4j
public class SqsMessagePollRunner implements Runnable { // NOPMD - cc
	 ...
	 * コンストラクタ
	 */
	public SqsMessagePollRunner(AmazonSQS sqs, RetryTemplate retry, String workerQueueUrl,
